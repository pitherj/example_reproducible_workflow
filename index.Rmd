...
knitr::include_graphics("more/ecosystem_diagram_grey.png")
```

An overview flow-chart of the entire workflow is provided in this [PDF document](more/full_example_workflow_diagram_2025.pdf).
