...
We have a new (April 2026) preprint introducing a new tool: ["Concise guidelines for producing reliable, reproducible research"](more/Pither_Vis-Dunbar_concise_guidelines_preprint.pdf). A complementary R package called ["rrchecklist"](https://github.com/pitherj/rrchecklist) is also introduced. Take a look!
